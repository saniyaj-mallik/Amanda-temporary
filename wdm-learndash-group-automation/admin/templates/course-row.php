...
/**
 * WisdmLabs Customization to change the link of the course to the link of the first lesson of the course.
 */
if ( ! empty( $course_id ) ) {
	$steps        = learndash_get_course_steps( $course_id );
	$lesson_id    = ! empty( $steps ) && isset( $steps[0] ) ? $steps[0] : 0;
	$redirect_url = get_the_permalink( $lesson_id );
}
?>
...
<div class="<?php echo esc_attr( $course_class ); ?>" id="<?php echo esc_attr( 'ld-course-list-item-' . $course_id ); ?>">
	<div class="ld-item-list-item-preview">
		...
		<a href="<?php echo esc_url( $redirect_url ); ?>" class="ld-item-name">
