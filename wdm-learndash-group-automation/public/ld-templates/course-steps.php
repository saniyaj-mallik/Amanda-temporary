...
if ( ! empty( $learndash_previous_step_id ) && learndash_get_post_type_slug( 'lesson' ) === get_post_type( $learndash_previous_step_id ) ) {
	$learndash_previous_step_post = get_post( $learndash_previous_step_id );
	$learndash_previous_step_id   = learndash_previous_post_link( null, 'id', $learndash_previous_step_post );
}
...
if ( true === (bool) $learndash_maybe_show_next_step_link ) {
	...
	if ( ! empty( $learndash_next_step_id ) && learndash_get_post_type_slug( 'lesson' ) === get_post_type( $learndash_next_step_id ) ) {
		$learndash_next_step_post = get_post( $learndash_next_step_id );
		$learndash_next_step_id   = learndash_next_post_link( null, 'id', $learndash_next_step_post );
	}
